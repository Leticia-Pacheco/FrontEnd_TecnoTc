import { Container, ContainersCheck, Header, Informacoes, Overlay, } from "./styles";
                ...
                <Container>
                    ...
                    <Informacoes>
                        ...
                        <ContainersCheck>
                            <ul>
                                <li>
                                    <img id="ImageTarefasEmEspera" src={ImageTarefasEmEspera} alt="Em espera" title="Em espera"/>
                                    <h3>
                                        Tarefas em espera
                                    </h3>
                                </li>
