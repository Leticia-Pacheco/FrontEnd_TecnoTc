import { Container, Conteudo, Header, SobreNos, Oferecemos, NossoApp, Equipe, Footer, MenuContainer, Logo, TextoHeader, Informacoes, OferecItem, TextoNossoApp, ImageApp, PerfisEquipe, Contatos, TermosPrivacidade, } from "./styles";
   ...
   <>
    <Container>
      <Conteudo>
        ...
        <NossoApp>
          <Informacoes>
            <TextoNossoApp>
              ...
              <p>Pensando em nossos usuários, a TecnoTc estendeu a plataforma para uma versão mobile para que, de onde estiverem,
                 possam acessar ter acesso aos conteúdos e atividades. De forma prática e rápida, o seu projeto na palma da
                 sua mão!</p>
            </TextoNossoApp>
            <ImageApp>
        ...
        <Equipe>
          <h1>Nossa equipe</h1>
          <p>Nos esforçamos para que nossos usuários sempre tenham uma ótima experiência ao usarem a plataforma!</p>

          <Informacoes>
            <PerfisEquipe>
              <h3>Diretora Geral</h3>
              <img src={IntegLeticia} alt="Imagem de um dos integrantes da equipe" title="Imagem de um dos integrantes da equipe"/>
              <span>Letícia Pacheco</span>
              <p>Desenvolvedora Front-end web e mobile</p>
            </PerfisEquipe>
            <PerfisEquipe>
              <h2>Gerente de Desenvolvimento</h2>
              <img src={IntegDaniel} alt="Imagem de um dos integrantes da equipe" title="Imagem de um dos integrantes da equipe"/>
              <span>Daniel Vitor</span>
              <p>Desenvolvedor Back-end</p>
            </PerfisEquipe>
            <PerfisEquipe>
              <h3>Gerente Financeiro</h3>
              <img src={IntegKarina} alt="Imagem de um dos integrantes da equipe" title="Imagem de um dos integrantes da equipe"/>
              <span>Karina Soares</span>
              <p>Desenvolvedora Front-end web e mobile</p>
            </PerfisEquipe>
            <PerfisEquipe>
              <h3>Gerente Jurídico</h3>
              <img src={IntegBianca} alt="Imagem de um dos integrantes da equipe" title="Imagem de um dos integrantes da equipe"/>
        ...
        <Footer>
          <Contatos>
            <ul>
              <li> 
                <img src={ContWhatsapp} alt="Contato para whatsapp" title="Contato para whatsapp"/>
                <p>(11) 94981-9506</p>
              </li>
              <li> 
                <img src={ContInstagram} alt="Contato para instagram" title="Contato para instagram"/> 
                <p>tecnotc_</p>
              </li>
              <li> 
                <img src={ContEmail} alt="Contato para email" title="Contato para email"/> 
